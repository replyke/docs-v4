...
## Overview
The `useSignOut` hook allows users to securely log out of their account by invalidating their session on the server. This hook integrates with Replyke’s authentication system and ensures proper session termination.

## Usage Example

```tsx
import { useSignOut } from "replyke";
