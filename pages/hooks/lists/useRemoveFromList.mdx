...
```tsx
import { useRemoveFromList } from "replyke";
...
| `currentList`  | `List`   | Yes      | The list from which the entity will be removed.  |
...
|--------------|--------|-----------------------------------------------|
| `List`       | `List` | The details of the updated list without the removed entity. |
