...
```tsx
import { useCommentVotes } from "replyke";
...
|---------------|------------------------------------------------|----------|------------------------------------------|
| `comment`     | `CommentType`                                 | Yes      | The comment object to manage votes for.  |
| `setComment`  | `React.Dispatch<React.SetStateAction<CommentType>>` | Yes      | A state setter function for the comment. |
