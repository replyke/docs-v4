...
```
GET /:projectId/entities/single?referenceId=home-page
```

Fetch by entity ID:
```
GET /:projectId/entities/single?entityId=12345
```

Fetch by short ID:

```
GET /:projectId/entities/single?shortId=abc123
```
