...
|------------------------|---------------------------------------------------------------------------------------------------------------------|
| `entityComment`        | `entityTitle`, `entityContent`, `commentContent`, `initiatorName`, `initiatorUsername`, `initiatorAvatar`            |
| `commentReply`         | `entityTitle`, `entityContent`, `commentContent`, `replyContent`, `initiatorName`, `initiatorUsername`, `initiatorAvatar` |
| `entityMention`        | `entityTitle`, `entityContent`, `initiatorName`, `initiatorUsername`, `initiatorAvatar`                              |
| `commentMention`       | `entityTitle`, `entityContent`, `commentContent`, `initiatorName`, `initiatorUsername`, `initiatorAvatar`            |
| `entityUpvote`         | `entityTitle`, `entityContent`, `initiatorName`, `initiatorUsername`, `initiatorAvatar`                              |
| `commentUpvote`        | `entityTitle`, `entityContent`, `commentContent`, `initiatorName`, `initiatorUsername`, `initiatorAvatar`            |
| `newFollow`            | `initiatorName`, `initiatorUsername`, `initiatorAvatar`                                                             |
