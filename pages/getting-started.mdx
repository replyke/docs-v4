...
<Tabs items={["npm", "pnpm", "yarn"]}>
  ...
  ```
    ...
    <Tabs.Tab>
  ```bash
  pnpm add replyke@beta
  ```
  </Tabs.Tab>
    <Tabs.Tab>
  ```bash
  yarn add replyke@beta
  ```
  </Tabs.Tab>
</Tabs>
...
<Tabs items={["npm", "pnpm", "yarn"]}>
  ...
  ```
    ...
    <Tabs.Tab>
  ```bash
  pnpm add replyke-rn@beta
  ```
  </Tabs.Tab>
    <Tabs.Tab>
  ```bash
  yarn add replyke-rn@beta
  ```
  </Tabs.Tab>
</Tabs>
...
The `ProjectProvider` component from Replyke should wrap your entire app to provide access to Replyke’s features. Place it at the top level of your application, passing the `projectId` as a prop. Here’s an example:
